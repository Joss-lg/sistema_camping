            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50 border-b border-slate-100">
                        ...
                        <th class="px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Abastecimiento</th>
                    ...
                    @forelse ($proveedores as $proveedor)
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-sm text-slate-600">
                                <div class="space-y-1">
                                    <div>Entrega: <span class="font-semibold">{{ $proveedor->tiempo_entrega_dias }} días</span></div>
                                    <div>Crédito: <span class="font-semibold">{{ $proveedor->dias_credito }} días</span></div>
                                    <div>Calidad: <span class="font-semibold">{{ number_format((float) $proveedor->calificacion, 1) }}/5</span></div>
                                </div>
                            </td>
